        ...
        <>
            <div className="grid grid-cols-2 bg-gradient border border-border">
                ...
                <div className="about-us flex flex-col justify-between p-14">
                    ...
                    <Link href="#" className='w-[70%] flex items-center justify-between gap-4 text-[72px]/[60px] font-sans font-normal tracking-tight text-primary border-b-2 border-primary rounded-sm mb-6'>Get Started <HiOutlineArrowRight/></Link>
                </div>
            </div>
        </>
    )
