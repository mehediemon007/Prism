        ...
        <>
            ...
            <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 bg-gradient border border-border">
                ...
                <div className="about-us flex flex-col justify-between p-6 xl:p-14">
                    ...
                    <Link href="#" className='w-max xl:w-[75%] flex items-center justify-between gap-4 text-[20px]/[32px] xl:text-[72px]/[60px] font-sans font-normal tracking-tight text-primary border-b-2 border-primary rounded-sm mt-4 mb-3 xl:mt-0 xl:mb-6'>Get Started <HiOutlineArrowRight/></Link>
                </div>
            </div>
        </>
    )
