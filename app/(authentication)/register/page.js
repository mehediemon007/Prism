            ...
            <div className="pri-auth">
                <div className='sticky top-0 flex justify-between items-center py-4 lg:py-6 bg-black z-20'>
                    ...
                    <div className="space-x-4">
                        <span className='text-xs md:text-sm lg:text-base font-normal font-text'>Already a member</span>
                        <Link href="/login" className='text-xs md:text-sm lg:text-base font-normal font-text text-black px-4 py-2 bg-white rounded-lg inline-flex justify-center items-center'>Sign In</Link>
                    </div>
                </div>
                <div className="heading text-center space-y-2">
                    <Image src="/assets/imgs/user.svg" alt="user" width={88} height={88} className="mb-2"/>
                    <h2 className="text-xl lg:text-2xl font-title">Register your account</h2>
                    <p className="text-sm lg:text-base font-text">Enter your details to Register.</p>
                </div>
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-y-4 lg:gap-4">
                    <p className="lg:col-span-2 text-sm font-text text-primary flex items-center gap-2 mt-4 lg:my-4"><IoMdAlert/> Please use your real information as this will need to be confirmed.</p>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                        <div className="input-grp required relative lg:col-span-2">
                    ...
                    <p className="lg:col-span-2 text-sm font-text text-primary flex items-center gap-2 lg:my-4"><IoMdAlert/> Please use your real information as this will need to be confirmed.</p>
                    <div className="grid lg:grid-cols-3 lg:col-span-2 gap-4">
                        <div className="input-grp required relative col-span-1">
