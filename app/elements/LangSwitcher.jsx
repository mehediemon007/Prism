...
const LangSwitcher = () => {
  ...
  return (
    <div className="">
        <div onClick={() => setOpen(!open)} className={`flex items-center justify-between cursor-pointer p-2 ps-4`}>
            <span className="flex gap-1 items-center"><CiGlobe size={24}/> <b className='text-xs lg:text-sm font-text font-normal'>{selected.name}</b></span>
